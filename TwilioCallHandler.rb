...
get '/' do
	Twilio::TwiML::Response.new do |r|
  	r.Gather :numDigits => '1', :action => '/handle-gather', :method => 'get' do |g|
  		g.Say 'You have reached Optimum Anesthesia. For requests for proposals or sales, press 1. For all other inquires, press 2. To hear this message again, press any other number.', :voice => 'woman'
  	end
  end.text
end
...
get '/handle-gather' do
	...
	Twilio::TwiML::Response.new do |r|
		r.Say 'Please wait while we connect you.', :voice => 'woman'
		if params['Digits'] == '1'
